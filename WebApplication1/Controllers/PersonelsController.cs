...
namespace WebApplication1.Controllers
{
    public class PersonelsController : Controller
    {
        ...
        public PersonelsController(SirketDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Adsoyad,Dogum")] Personel personel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Adsoyad,Dogum")] Personel personel)
        {
            if (id != personel.Id)
            {
                return NotFound();
